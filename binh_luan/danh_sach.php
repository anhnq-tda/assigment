<?php 
  ...
  */ 
  $query = "SELECT * FROM binh_luan order by ma_bl desc";
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <tr>
                    <td><?php echo $item['ma_bl']?></td>
                    <td><?php echo $item['noi_dung']?></td>
                    <td><?php echo $item['ngay_bl']?></td>
                    <td>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="./xoa.php?ma_bl=<?php echo $item['ma_bl'];?>&ma_hh=<?php echo $item['ma_hh']?>&ma_kh=<?php echo $item['ma_kh']?>"><button class="btn btn-danger">Xoá</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
