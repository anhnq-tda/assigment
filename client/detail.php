...
<!-- Mirrored from demo.7uptheme.com/html/kuteshop/detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jul 2018 02:58:51 GMT -->
		...
		<div class="header-ontop">
			...
			<div class="row">
				<div class="col-md-2 col-sm-2 col-xs-12">
					<div class="logo">
						<a href="index.html"><img src="images/home4/logo.png" alt=""></a>
					</div>
				</div>
					...
					<div class="check-cart check-cart-ontop">
						<div class="checkout-box">
							...
							<ul class="list-checkout list-unstyled">
								...
								<li><a href="#"><i class="fa fa-key" aria-hidden="true"></i>Đ</a></li>
						...
						<div class="product-detail accordion-detail border radius">
							...
							<div class="tab-detal toggle-tab">
								<div class="item-toggle-tab active">
									<h2 class="toggle-tab-title title14 radius border">Mô Tả</h2>
								...
								<div class="item-toggle-tab">
									<h2 class="toggle-tab-title title14 radius border">Bình Luận</h2>
									<div class="toggle-tab-content">
										<div class="content-detail-tab">
											<div class="detail-tab-thumb">
												<img src="images/shop/tab-img.png" alt="" />
						...
						<div class="sidebar sidebar-right">
							<div class="list-detail-adv">
								<div class="detail-adv">
									<a href="#"><img class="radius wobble-horizontal" alt="" src="images/shop/pro-adv1.jpg"></a>
								</div>
								<div class="detail-adv">
									<a href="#"><img class="radius wobble-horizontal" alt="" src="images/shop/pro-adv2.jpg"></a>
								</div>
								<div class="detail-adv">
									<a href="#"><img class="radius wobble-horizontal" alt="" src="images/shop/pro-adv3.jpg"></a>
								</div>
							</div>
								...
								<div class="widget-content">
									<div class="wrap-item" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1]]">
										...
										<div class="list-pro-seller">
											<div class="item-pro-seller">
												<div class="product-thumb">
													<a href="#" class="product-thumb-link"><img src="images/photos/homeware/3.jpg" alt="" /></a>
												</div>
												<div class="product-info">
													<h3 class="product-title"><a href="detail.html">new favorite</a></h3>
													<div class="product-price">
											...
											<div class="item-pro-seller">
												<div class="product-thumb">
													<a href="#" class="product-thumb-link"><img src="images/photos/homeware/4.jpg" alt="" /></a>
												</div>
												<div class="product-info">
													<h3 class="product-title"><a href="detail.html">new favorite</a></h3>
													<div class="product-price">
											...
											<div class="item-pro-seller">
												<div class="product-thumb">
													<a href="#" class="product-thumb-link"><img src="images/photos/homeware/10.jpg" alt="" /></a>
												</div>
												<div class="product-info">
													<h3 class="product-title"><a href="detail.html">new favorite</a></h3>
													<div class="product-price">
		...
		<div class="footer footer4">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="item-tag-footer">
								<div class="title-tag-footer"><span style="width:130px">Địa Chỉ:</span></div>
			...
			<div class="footer-copyright">
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-sm-8 col-xs-12">
							<p class="copyright">Gamntph14216 © 2021 All rights reserved.</p>
						</div>
...
<!-- Mirrored from demo.7uptheme.com/html/kuteshop/detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jul 2018 02:59:14 GMT -->
</html>