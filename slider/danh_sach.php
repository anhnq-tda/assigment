<?php 
  ...
  */ 
  $query = "SELECT * FROM slider order by ma_sl desc";
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <div style="padding-top: 15px;">
                    <a href="./them_moi.php"><button class="btn btn-success" type="button">Thêm mới</button></a>
                  </div>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
                ...
                <tr>
                    <td><?php echo $item['ma_sl']?></td>
                    <td><?php echo $item['ten_sl']?></td>
                    <td><img src="../images/<?php echo $item['hinh']?>" alt="" style="width: 150px; height: 150px"></td>
                    <td>
                      <a href="chinh_sua.php?ma_sl=<?php echo $item['ma_sl'];?>"><button class="btn btn-primary">Sửa</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="./xoa.php?ma_sl=<?php echo $item['ma_sl'];?>"><button class="btn btn-danger">Xoá</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
