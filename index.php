      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- <li class="nav-item">
                <a href="users/list-user.php" class="nav-link">
            ...
            <li class="nav-item">
                <a href="products/list-product.php" class="nav-link">
                <i class="nav-icon fas fa-chart-pie"></i>
                <p>
                    Quản lý sản phẩm
                    <i class="right fas fa-angle-left"></i>
            ...
            <a href="./loai_hang/danh_sach.php" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                  Quản lý  Loại Hàng
                  <i class="right fas fa-angle-left"></i>
            ...
            <a href="./hang_hoa/danh_sach.php" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                  Quản lý Hàng Hóa
                  <i class="right fas fa-angle-left"></i>
            ...
            <a href="./khach_hang/danh_sach.php" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                  Quản lý Khách Hàng
                  <i class="right fas fa-angle-left"></i>
            ...
            <a href="./binh_luan/danh_sach.php" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                  Quản lý Bình Luận
                  <i class="right fas fa-angle-left"></i>
            ...
            <a href="./slider/danh_sach.php" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p>
                  Quản lý Slider
                  <i class="right fas fa-angle-left"></i>
