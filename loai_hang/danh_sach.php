<?php 
  ...
  */ 
  $query = "SELECT * FROM loai_hang order by ma_loai desc";
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <tr>
                    ...
                    <td>
                      <a href="chinh_sua.php?ma_loai=<?php echo $item['ma_loai'];?>"><button class="btn btn-primary">Sửa</button></a>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="./xoa.php?ma_loai=<?php echo $item['ma_loai'];?>"><button class="btn btn-danger">Xoá</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
